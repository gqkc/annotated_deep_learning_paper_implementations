...
class DenoiseDiffusion:
    ...
    def __init__(self, eps_model: nn.Module, n_steps: int, device: torch.device, linspace_start=0.0001,
                 linspace_end=0.02):
        """
        ...
        * `device` is the device to place constants on
        ...
        self.beta = torch.linspace(linspace_start, linspace_end, n_steps).to(device)
